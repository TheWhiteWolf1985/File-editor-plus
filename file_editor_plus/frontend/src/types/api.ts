...
export type UserConfig = { font_base_rem?: number; theme_mode?: ThemeMode; toolbar_visible?: boolean };
export type Snippet = { id: string; name: string; description: string; content: string };
export type SearchMatch = { line: number; column: number; preview: string; match_len: number };
